...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-mini"><b>S</b>WT</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>SIMAWiTa</b></span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="/adminlte/img/BUYUNG.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Puyuh
                        <small><i class="fa fa-clock-o"></i> 5 menit</small>
                      </h4>
                      <p>Bagaimana perkembangan promosinya?</p>
                    </a>
                  </li>
                  <!-- end message -->
                </ul>
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                ...
                <ul class="menu">
                  <li>
                    <a href="#">
                      <i class="fa fa-users text-aqua"></i> Hasil promosi bulan ini telah keluar
                    </a>
                  </li>
                </ul>
              </li>
          ...
          <li class="dropdown tasks-menu">
            ...
            <ul class="dropdown-menu">
              <li class="header">Anda memiliki 2 tugas</li>
              <li>
                <!-- inner menu: contains the actual data -->
                <ul class="menu">
                  <li><!-- Task item -->
  ...
  <aside class="control-sidebar control-sidebar-dark">
    ...
    <div class="tab-content">
      ...
      <div class="tab-pane" id="control-sidebar-home-tab">
        ...
        <h3 class="control-sidebar-heading">Kegiatan Promosi</h3>
        <ul class="control-sidebar-menu">
          <li>
            <a href="javascript:void(0)">
              <h4 class="control-sidebar-subheading">
                Mempromosikan Malioboro
